...
func (_c *NotificationCreate) SetActionType(v string) *NotificationCreate {
	_c.mutation.SetActionType(v)
	return _c
}

// SetNillableActionType sets the "action_type" field if the given value is not nil.
func (_c *NotificationCreate) SetNillableActionType(v *string) *NotificationCreate {
	if v != nil {
		_c.SetActionType(*v)
	}
	return _c
...
func (_c *NotificationCreate) SetActionData(v map[string]interface{}) *NotificationCreate {
