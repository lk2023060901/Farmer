...
type ActivityLogQuery struct {
	...
	withLikes    *ActivityLikeQuery
	withComments *ActivityCommentQuery
...
func (_q *ActivityLogQuery) QueryAuthor() *UserQuery {
...
func (_q *ActivityLogQuery) QueryLikes() *ActivityLikeQuery {
...
func (_q *ActivityLogQuery) QueryComments() *ActivityCommentQuery {
...
func (_q *ActivityLogQuery) WithAuthor(opts ...func(*UserQuery)) *ActivityLogQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *ActivityLogQuery) WithLikes(opts ...func(*ActivityLikeQuery)) *ActivityLogQuery {
	query := (&ActivityLikeClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ActivityLogQuery) WithComments(opts ...func(*ActivityCommentQuery)) *ActivityLogQuery {
	query := (&ActivityCommentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ActivityLogQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*ActivityLog, error) {
	...
	if query := _q.withAuthor; query != nil {
		if err := _q.loadAuthor(ctx, query, nodes, nil,
			func(n *ActivityLog, e *User) { n.Edges.Author = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withLikes; query != nil {
		if err := _q.loadLikes(ctx, query, nodes,
			func(n *ActivityLog) { n.Edges.Likes = []*ActivityLike{} },
			func(n *ActivityLog, e *ActivityLike) { n.Edges.Likes = append(n.Edges.Likes, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withComments; query != nil {
		if err := _q.loadComments(ctx, query, nodes,
			func(n *ActivityLog) { n.Edges.Comments = []*ActivityComment{} },
			func(n *ActivityLog, e *ActivityComment) { n.Edges.Comments = append(n.Edges.Comments, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ActivityLogQuery) loadAuthor(ctx context.Context, query *UserQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *User)) error {
...
func (_q *ActivityLogQuery) loadLikes(ctx context.Context, query *ActivityLikeQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *ActivityLike)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(activitylike.FieldActivityID)
	}
	query.Where(predicate.ActivityLike(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(activitylog.LikesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ActivityLogQuery) loadComments(ctx context.Context, query *ActivityCommentQuery, nodes []*ActivityLog, init func(*ActivityLog), assign func(*ActivityLog, *ActivityComment)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*ActivityLog)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(activitycomment.FieldActivityID)
	}
	query.Where(predicate.ActivityComment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(activitylog.CommentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
