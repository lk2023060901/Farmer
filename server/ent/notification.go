...
type Notification struct {
	...
	// social/trade/village/system/event
...
func (*Notification) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case notification.FieldType, notification.FieldTitle, notification.FieldContent, notification.FieldActionType:
