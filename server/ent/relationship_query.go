...
func (_q *RelationshipQuery) QueryUserA() *UserQuery {
...
func (_q *RelationshipQuery) QueryUserB() *UserQuery {
	query := (&UserClient{config: _q.config}).Query()
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := _q.prepareQuery(ctx); err != nil {
			return nil, err
...
func (_q *RelationshipQuery) WithUserA(opts ...func(*UserQuery)) *RelationshipQuery {
	query := (&UserClient{config: _q.config}).Query()
...
func (_q *RelationshipQuery) WithUserB(opts ...func(*UserQuery)) *RelationshipQuery {
	query := (&UserClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *RelationshipQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Relationship, error) {
	...
	if query := _q.withUserA; query != nil {
		if err := _q.loadUserA(ctx, query, nodes, nil,
			func(n *Relationship, e *User) { n.Edges.UserA = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withUserB; query != nil {
		if err := _q.loadUserB(ctx, query, nodes, nil,
			func(n *Relationship, e *User) { n.Edges.UserB = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RelationshipQuery) loadUserA(ctx context.Context, query *UserQuery, nodes []*Relationship, init func(*Relationship), assign func(*Relationship, *User)) error {
...
func (_q *RelationshipQuery) loadUserB(ctx context.Context, query *UserQuery, nodes []*Relationship, init func(*Relationship), assign func(*Relationship, *User)) error {
	ids := make([]uuid.UUID, 0, len(nodes))
	nodeids := make(map[uuid.UUID][]*Relationship)
	for i := range nodes {
		fk := nodes[i].UserBID
...
func (_q *RelationshipQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withUserA != nil {
			_spec.Node.AddColumnOnce(relationship.FieldUserAID)
		}
		if _q.withUserB != nil {
			_spec.Node.AddColumnOnce(relationship.FieldUserBID)
		}
	}
